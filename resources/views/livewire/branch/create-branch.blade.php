<div>
    <x-button @click="$wire.set('CreateBranchModal', true)" class="mt-5 mr-9 mb-5 hover:bg-indigo-700 bg-indigo-500 float-right">
        <i class="fa-solid fa-circle-plus fa-xl"></i>&ensp;
        {{ __('Branch') }}
    </x-button>
    <x-dialog-modal wire:model.live="CreateBranchModal" submit="save">
        ...
        <x-slot name="footer">
            <x-secondary-button @click="$wire.set('CreateBranchModal', false)" wire:loading.attr="disabled">
