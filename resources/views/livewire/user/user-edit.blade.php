        ...
        <x-slot name="content">
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12">
                    ...
                    <x-input id="form.name" name="form.name" wire:model="form.name" type="text" class="mt-1 block w-full"  autocomplete="form.name" />
                    <x-input-error for="form.name" class="mt-2" />
                </div>

                <div class="col-span-12">
                    <x-label for="form.username" value="{{ __('Username') }}" />
                    <x-input id="form.username" name="form.username" wire:model="form.username" type="text" class="mt-1 block w-full"  autocomplete="form.username" />
                    <x-input-error for="form.username" class="mt-2" />
                </div>

                <div class="col-span-12">
                    <x-label for="form.email" value="{{ __('Email') }}" />
                    <x-input id="form.email"  name="form.email" wire:model="form.email" type="text" class="mt-1 block w-full"  autocomplete="form.email" />
                ...
                <div class="col-span-12">
                    ...
                    <select  id="form.branch" name="form.branch" wire:model="form.branch" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" autocomplete="form.branch">
                ...
                <div class="col-span-12">
                    ...
                    <select id="form.department" name="form.department" wire:model="form.department" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" autocomplete="form.department">
