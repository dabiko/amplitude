<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link href="{{ route('branch.index') }}"  wire:navigate :active="request()->routeIs('branch.index')">
                        {{ __('Branch') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link href="{{ route('department.index') }}"  wire:navigate :active="request()->routeIs('department.index')">
                        {{ __('Department') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link href="{{ route('session.index') }}"  wire:navigate :active="request()->routeIs('session.index')">
                        {{ __('Session') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link href="{{ route('log.index') }}"  wire:navigate :active="request()->routeIs('log.index')">
                        {{ __('Log') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('branch.index') }}" wire:navigate :active="request()->routeIs('branch.index')">
                {{ __('Branch') }}
            </x-responsive-nav-link>
        </div>
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('user.index') }}" wire:navigate :active="request()->routeIs('user.index')">
                {{ __('User') }}
            </x-responsive-nav-link>
        </div>

        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('session.index') }}" wire:navigate :active="request()->routeIs('session.index')">
                {{ __('Session') }}
            </x-responsive-nav-link>
        </div>

        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('log.index') }}" wire:navigate :active="request()->routeIs('log.index')">
                {{ __('Log') }}
            </x-responsive-nav-link>
        </div>
